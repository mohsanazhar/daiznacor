...
return [
    ...
    "policy" => "Policy",
    "policy-list" => "Insurance Policies List",
    "policy-issuance" => "Policy Issuance",
    "policy-expiration" => "Policy Expiration",
    "policy-add" => "Add Insurance Policies",
    "policy-update" => "Update Insurance Policies",
    "policies" => "Insurance Policies",
    "insurance-company" => "Insurance Company",
    "name-insure" => "Name of Insure",
    "policy-num" => "No. Policy",
    "delete" => "Delete",
    "edit" => "Edit",
    "actions" => "Actions",
    "close" => "Close",
    "street" => "Street",
    "no-local" => "No. House / APT / Local",
    ...
    "phone" => "Phone Number",
    "modules" => "Modules",
    "insuranceCar" => "Insurance Cars",
    "listInsuranceCar" => "List cars",
    "addInsuranceCar" => "Add new",
    "cars" => "Cars",
    "newCar" => "New Car",
    "listCars" => "List car",
    "newBrand" => "New brand",
    ...
    "licensePlateRenewal" => "License Plate Renewal",
    "carPaperwork" => "Cars paperwork",
    ...
    'scanned-sticker'=>'Scanned Sticker',
    'photos-01'=>'Photos-01',
    'photos-02'=>'Photos-02',
    'photos-03'=>'Photos-03',
    'photos-04'=>'Photos-04',
