...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <a href="index" class="logo logo-dark">
            <span class="logo-sm">
                <img src="/build/images/logo-sm.png" alt="" height="38">
            </span>
            <span class="logo-lg">
                <img src="/build/images/logo-dark.png" alt="" height="38">
            </span>
        </a>
        <a href="index" class="logo logo-light">
            <span class="logo-sm">
                <img src="/build/images/logo-sm.png" alt="" height="24">
            </span>
            <span class="logo-lg">
                <img src="/build/images/logo-light.png" alt="" height="24">
            </span>
        </a>
