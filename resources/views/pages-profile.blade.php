                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div class="card profile-project-card shadow-none mt-3">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="text-center mb-4 me-3">
                                                <img src="/build/images/companies/img-8.png" alt="" width="30px" height="30px" class="">
                                            </div>
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="/build/images/users/avatar-1.jpg" alt="" class="avatar-md rounded-3" />
                                        </div>
                            ...
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="/build/images/users/avatar-2.jpg" alt="" class="avatar-md rounded-3" />
                                        </div>
                                        <div class="text-center">
                                            <a href="#member-overview" data-bs-toggle="offcanvas">
                            ...
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="/build/images/users/avatar-3.jpg" alt="" class="avatar-md rounded-3" />
                                        </div>
                                        <div class="text-center">
                                            <a href="#member-overview" data-bs-toggle="offcanvas">
                            ...
                            <div class="col-xxl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <img src="/build/images/users/avatar-4.jpg" alt="" class="avatar-md rounded-3" />
                                        </div>
                                        <div class="text-center">
                                            <a href="#member-overview" data-bs-toggle="offcanvas">
