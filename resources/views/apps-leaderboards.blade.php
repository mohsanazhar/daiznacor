                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex border-bottom pb-3">
                            ...
                            <div class="flex-shrink-0">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-transparent rounded fs-2">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex border-bottom pb-3">
                            <div class="flex-grow-1">
                                <h4 class="fs-17 fw-semibold">Nacor Díaz</h4>
                            ...
                            <div class="flex-shrink-0">
                                <div class="avatar-sm">
                                    <span class="avatar-title rounded fs-2">
                                        <img class="rounded img-fluid" src="/build/images/users/avatar-1.jpg" alt="Header Avatar">
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body ribbon-box right">
                        <div class="text-center py-3">
                            ...
                            <div class="mx-auto avatar-md p-1 border rounded-circle">
                                <img src="/build/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="">
                            </div>
                ...
                <div class="card">
                    <div class="card-body ribbon-box right">
                        <div class="text-center py-3">
                            ...
                            <div class="mx-auto avatar-md p-1 border rounded-circle">
                                <img src="/build/images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="">
                            </div>
                ...
                <div class="card">
                    <div class="card-body ribbon-box right">
                        <div class="text-center py-3">
                            ...
                            <div class="mx-auto avatar-md p-1 border rounded-circle">
                                <img src="/build/images/users/avatar-7.jpg" class="img-fluid rounded-circle" alt="">
                            </div>
                        ...
                        <tbody>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="/build/images/users/avatar-1.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1">Nacor Díaz</h6>
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="/build/images/users/avatar-3.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="/build/images/users/avatar-8.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="/build/images/users/avatar-9.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                            ...
                            <tr>
                                ...
                                <td style="width: 160px;">
                                    <div class="d-flex">
                                        <div class="avatar-sm p-1 border rounded-circle me-3">
                                            <img src="/build/images/users/avatar-10.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                ...
                <div data-simplebar style="max-height: 380px;" class="p-3 pt-0">
                    ...
                    <a href="#!" class="d-flex border-bottom py-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <span class="text-muted">Nacor Díaz, sed porta finibus, risus Chris Wallace Commented <b class="text-primary"> Developer Moreno</b></span>
                        </div>
                    </a>
                    ...
                    <a href="#!" class="d-flex border-bottom py-3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="fs-16 mb-1">Marvin J. Veras</h5>
                            <span class="text-muted">Nacor Díaz, Chris combined with Wallace They Commented <b class="text-primary">UX Murphy</b></span>
                        </div>
                    </a>
