        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <span class="badge badge-outline-light text-light-emphasis">Light</span>
                </div>
            </div><!-- end card-body -->
            <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                <h5 class="fs-12 text-muted mb-0">HTML Preview</h5>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <span class="badge rounded-pill badge-outline-light text-light-emphasis">Light</span>
                </div>
            </div><!-- end card-body -->
            <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                <h5 class="fs-12 text-muted mb-0">HTML Preview</h5>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <span class="badge badge-label bg-light text-light-emphasis"><i class="mdi mdi-circle-medium"></i> Light</span>
                </div>
            </div><!-- end card-body -->
            <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                <h5 class="fs-12 text-muted mb-0">HTML Preview</h5>
