...
<div class="offcanvas offcanvas-end" tabindex="-1" id="viewContactoffcanvas" aria-labelledby="viewContactoffcanvasLabel">
    ...
    <div class="offcanvas-body">
        <div class="text-center">
            <div class="mb-3">
                <img src="/build/images/users/avatar-2.jpg" alt="" class="avatar-lg d-block mx-auto rounded-circle overview-userimg" />
            </div>
                        ...
                        <div class="position-relative d-inline-block">
                            ...
                            <div class="avatar-lg">
                                <div class="avatar-title bg-light rounded-circle">
                                    <img src="/build/images/users/user-dummy-img.jpg" id="contact-img" class="avatar-md rounded-circle" />
                                </div>
                            </div>
                        </div>
                    </div>
