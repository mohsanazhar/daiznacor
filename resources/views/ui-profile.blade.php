        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card border-0 shadow-none mb-0">
                    ...
                    <div class="card-body">
                        <div class="mt-n5">
                            <img src="/build/images/users/avatar-1.jpg" alt="" class="avatar-lg rounded-circle p-1 mt-n3">
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-none mb-0">
                    ...
                    <div class="card-body">
                        <div class="mt-n5 text-center">
                            <img src="/build/images/users/avatar-1.jpg" alt="" class="avatar-lg rounded-circle p-1 mt-n3 mx-auto">
                        </div>
                    </div>
                    <div class="card-body pt-0">
...
<div class="row">
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <img src="/build/images/small/img-4.jpg" alt="" class="w-100 rounded object-cover" height="120">

                <div class="text-center">
                    <div class="mt-n4">
                        <img src="/build/images/users/avatar-1.jpg" alt="" class="avatar-md rounded-circle p-1 mt-n2">
                    </div>
