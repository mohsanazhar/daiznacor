...
@section('title') @lang('translation.apikey') @endsection
@section('css')
    ...
    <div class="col-xxl-3 col-md-6">
        <div class="card card-height-100">
            <div class="card-body">
                ...
                <div class="text-end">
                    <button type="button" class="btn btn-info btn-sm create-btn" data-bs-toggle="modal" data-bs-target="#api-key-modal">Create API Key</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xxl-3 col-md-6">
        <div class="card">
            ...
            <div class="card-body pb-0">
                ...
                <div id="hours_spent_chart" data-colors='["--tb-primary","--tb-primary","--tb-primary","--tb-primary","--tb-primary","--tb-primary","--tb-primary","--tb-primary","--tb-primary", "--tb-primary"]' class="apex-chart"></div>
            </div>
        </div>
    </div>
</div>
                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="status"><span class="badge text-danger  bg-danger-subtle">Disable</span></td>
