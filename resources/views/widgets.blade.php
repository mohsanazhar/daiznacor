            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="fs-22 fw-semibold mb-3"><span class="counter-value" data-target="195.38">0</span>M </h4>
                        <div class="d-flex align-items-center gap-2">
                            <h5 class="text-success fs-12 mb-0">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="text-end flex-grow-1">
                        ...
                        <h4 class="fs-22 fw-semibold mb-3"><span class="counter-value" data-target="190.73">0</span>k </h4>
                        <div class="d-flex align-items-center justify-content-end gap-2">
                            <h5 class="text-danger fs-12 mb-0">
                                <i class="ri-arrow-right-down-line fs-13 align-middle"></i> -2.74 %
                            </h5>
        ...
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold mb-4">$<span class="counter-value" data-target="559.25">0</span>k</h4>
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate bg-info">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold mb-4 text-white"><span class="counter-value" data-target="36894">0</span></h4>
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold mb-4"><span class="counter-value" data-target="183.35">0</span>M</h4>
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold mb-4">$<span class="counter-value" data-target="190.73">0</span>k</h4>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0 align-self-center">
                        <span class="badge text-light-emphasis bg-light-subtle fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>6.11 %<span></span></span>
                    </div>
                </div>
            </div><!-- end card body -->
        </div>
        ...
        <div class="card card-height-100">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0 align-self-center">
                        <span class="badge text-danger  bg-danger-subtle fs-12"><i class="ri-arrow-down-s-line fs-13 align-middle me-1"></i>10.35 %<span></span></span>
                    </div>
                </div>
            </div><!-- end card body -->
        </div>
        ...
        <div class="card card-height-100">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0 align-self-center">
                        <span class="badge text-success  bg-success-subtle fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>22.96 %<span></span></span>
                    </div>
                </div>
            </div><!-- end card body -->
        </div>
        ...
        <div class="card card-height-100">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0 align-self-center">
                        <span class="badge text-success  bg-success-subtle fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>16.31 %<span></span></span>
                    </div>
                </div>
            </div><!-- end card body -->
        </div>
            ...
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-sm-auto">
                        <button type="button" class="btn btn-info btn-label rounded-pill"><i class="ri-markup-line label-icon align-middle rounded-pill fs-16 me-2"></i> Go Pro Now</button>
                    </div>
                </div>
        ...
        <div class="card card-primary border-0">
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-sm-auto">
                        <button type="button" class="btn btn-darken-primary btn-label rounded-pill"><i class="ri-markup-line label-icon align-middle rounded-pill fs-16 me-2"></i> Go Pro Now</button>
                    </div>
                </div>
                <div class="position-absolute top-0 start-50 mt-2 opacity-25">
                    <i class="bi bi-shop display-4"></i>
        ...
        <div class="card card-height-100">
            ...
            <div class="card-body">
                <div class="widgets-piechart pt-3 pb-2">
                    <div id="simple_dount_chart" data-colors='["--tb-info", "--tb-danger", "--tb-warning", "--tb-success"]' class="apex-charts" dir="ltr"></div>
                </div>
            </div>
            <div class="border-top border-top-dashed">
                <div class="row g-0">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                                            <img src="/build/images/users/avatar-1.jpg" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
    ...
    <div class="col-xxl-4 col-xl-6">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive table-card mt-4 pt-2 border-top-dashed border-top border-start-0 border-end-0 bg-light-subtle">
                    <table class="table table-borderless table-sm table-centered align-middle table-nowrap mt-3">
                        ...
                        <tbody class="border-0">
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-sm">
                                        <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 73%" aria-valuenow="73" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </td>
                                <td>73</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-success" role="progressbar" aria-label="Basic example" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </td>
                                <td>90</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-info" role="progressbar" aria-label="Basic example" style="width: 87%" aria-valuenow="87" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </td>
                                <td>87</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-danger" role="progressbar" aria-label="Basic example" style="width: 36%" aria-valuenow="36" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </td>
                                <td>36</td>
                            </tr>
    ...
    <div class="col-xxl-4 col-xl-6">
        <div class="card card-height-100">
            ...
            <div class="card-body p-0">
                <div>
                    <div id="countries_charts" data-colors='["--tb-info", "--tb-info", "--tb-info", "--tb-info", "--tb-danger", "--tb-info", "--tb-info", "--tb-info", "--tb-info", "--tb-info"]' class="apex-charts" dir="ltr"></div>
                </div>
            </div><!-- end card body -->
        </div><!-- end card -->
    </div> <!-- end col-->
    ...
    <div class="col-xxl-4">
        <div class="card card-height-100">
            ...
            <div class="card-body p-0 pb-2">
                <div>
                    <div id="column_stacked" data-colors='["--tb-primary", "--tb-danger"]' class="apex-charts" dir="ltr"></div>
                </div>
            </div><!-- end card body -->
        </div><!-- end card -->
    </div><!-- end col -->
                ...
                <ul class="list-group list-group-flush border-dashed mb-0">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="/build/images/svg/crypto-icons/btc.svg" class="img-fluid" alt="">
                                </span>
                            </div>
                            <div class="flex-grow-1 ms-2">
                    ...
                    <li class="list-group-item px-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="/build/images/svg/crypto-icons/eth.svg" class="img-fluid" alt="">
                                </span>
                            </div>
                            <div class="flex-grow-1 ms-2">
                    ...
                    <li class="list-group-item px-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="/build/images/svg/crypto-icons/ltc.svg" class="img-fluid" alt="">
                                </span>
                            </div>
                            <div class="flex-grow-1 ms-2">
                    ...
                    <li class="list-group-item px-0 pb-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="/build/images/svg/crypto-icons/dash.svg" class="img-fluid" alt="">
                                </span>
                            </div>
                            <div class="flex-grow-1 ms-2">
    ...
    <div class="col-xxl-4">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                ...
                <div id="color_heatmap" data-colors='["--tb-success", "--tb-info", "--tb-primary", "--tb-warning", "--tb-secondary"]' class="apex-charts mt-n3" dir="ltr"></div>
