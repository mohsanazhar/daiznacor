    ...
    formEvent.addEventListener('submit', function (ev) {
       ...
       // console.log(start_date);
        ...
        if (start_date.length > 1) {
            ...
            end_date  = (document.getElementById("event-start-date").value).split("to");
            //start_date = start_date.getFullYear()+"-"+start_date.getMonth()+"-"+start_date.getDay();
        ...
        if (forms[0].checkValidity() === true) {
            ...
            if (selectedEvent) {
                ...
                calendar.render();
                postData(defaultEvents[indexOfSelectedEvent]);
            } else {
                var newEvent = {
                   // id: e_id,
                    title: updatedTitle,
